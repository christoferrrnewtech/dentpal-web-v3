...
const AuthLayout = ({ children, title, subtitle }: AuthLayoutProps) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-300 via-cyan-400 to-teal-500 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl flex items-center justify-center">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden max-w-4xl w-full flex">
          {/* Left side - Branding */}
          <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-teal-400 to-cyan-500 p-12 flex-col justify-center items-center relative">
            <div className="text-center space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-6xl font-bold text-white">
                  Dent<span className="text-orange-300">Pal</span>
                </h1>
